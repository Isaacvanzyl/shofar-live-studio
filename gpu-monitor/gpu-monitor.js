...
// Set this to your church's Organisation ID from the Shofar Admin Panel.
// Leave blank to use the legacy shared channel.
const ORG_ID = ''

const CHANNEL_ID = ORG_ID ? `${ORG_ID}:gpu_stats` : 'gpu_stats'
